...
$cancel_return = site_url("?ptype=pstatus&pkg_type=$package_type&post_id=$post_id&user_id=$current_user->ID&user_name=$current_user->user_logi&post_title=$post_title&pay_method=$pay_methodn");
