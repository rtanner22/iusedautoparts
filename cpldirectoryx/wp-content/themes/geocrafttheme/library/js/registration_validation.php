    ...
    jQuery(document).ready(function()
{
	   ...
	   cap.blur(validate_captcha);
        cap.keyup(validate_captcha);
...
echo "if (validate_user_email() & validate_user_fname() & validate_pwd() & validate_cpwd() &validate_captcha())
            {
                return true;
            }
            else
