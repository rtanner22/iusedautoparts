...

{
  ...
  //die();
    ...
    */
    $headline1 = $cplmodel." ".$headline ."?";
    
    if (strlen($headline1) > 25)
    {
    $headline = $prefix1.$headline.$suffix;
    }else
    { $headline = $headline1;
    }
    ...
    {
      //$desc1 = $prefix1.$desc1;
      $desc1 = "Recycled ".$desc1.$suffix1;
    }



    $desc2= "Compare prices and save big.";
    //$desc2= $cplmodel ." ".$mkeywords;
    ...
    foreach ($kwlist as $kw) 
    {
      ...
      //echo "\"ARO-Main\",\"".$cplmake." ".$cplmodel." ".$kwlist[0]."\",\".50\",\"+".$mkeywords." +".$bkeywords.
...
dispurl,desturl,adgroupstatus,keywordstatus) VALUES ('IUAP-Main','".$cplmake." ".$cplmodel." ".$kwlist[0]."','.80',
...
$lcsql = "select distinct inventorynumber from inventory where quantityavailable>0 and modelyear > 1990 and substring(inventorynumber,4,1) = '-'
and substring(inventorynumber,1,3) in ('300','400','412','434','435','440')";
return $lcsql;
